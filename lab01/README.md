...
**Перевірка:** кожен рядок відповідає окремому процесу, який виконується одночасно; якщо вивід з’являється кілька разів, це означає, що MPI успішно працює, а середовище ініціалізовано правильно